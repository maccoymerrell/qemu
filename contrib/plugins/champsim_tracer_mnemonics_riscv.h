 ...
 *
 * The generic decoder maps x0 as REG_ZERO, so the rd==x0 case
 * shows up here as no destination or a single REG_ZERO destination.
 * rs1 == x1 shows up as REG_LR in src_regs.  Any "ret" pseudo
 * Capstone emits with no operands is treated as RETURN.
 */
static void refine_riscv_indirect_jr(
    const struct qemu_plugin_insn_info *info, InsnFields *f)
{
    (void)info;
    bool dst_is_x0 = f->n_dst_regs == 0 ||
                     (f->n_dst_regs == 1 && f->dst_regs[0] == REG_ZERO);
    if (!dst_is_x0) {
...
/*
 * JAL with a link destination is a direct call; JAL with rd=x0 is
 * the assembler's unconditional direct jump form.  The generic
 * decoder maps x0 as REG_ZERO, so rd=x0 appears as no destination or
 * a single REG_ZERO destination.
 */
static void refine_riscv_direct_jal(
    const struct qemu_plugin_insn_info *info, InsnFields *f)
{
    (void)info;
    bool dst_is_x0 = f->n_dst_regs == 0 ||
    ...
    f->opcode = GEN_OP_BRANCH;
    f->branch_type = BRANCH_DIRECT_JUMP;
    f->branch_conditional = false;
}
...
static const RegClassification riscv_reg_class[RISCV_REG_ENDING] = {
    ...
    [RISCV_REG_FFLAGS] = { REG_FCSR },  /* fflags */
    [RISCV_REG_FRM] = { REG_FCSR },  /* frm */
    [RISCV_REG_SSP] = { REG_SP },  /* ssp */
    [RISCV_REG_VL] = { REG_VCTRL },  /* vl */
    [RISCV_REG_VLENB] = { REG_VCTRL },  /* vlenb */
    [RISCV_REG_VTYPE] = { REG_VCTRL },  /* vtype */
    [RISCV_REG_VXRM] = { REG_VCTRL },  /* vxrm */
    [RISCV_REG_VXSAT] = { REG_VCTRL },  /* vxsat */
    [RISCV_REG_DUMMY_REG_PAIR_WITH_X0] = { REG_ZERO },  /* dummy_reg_pair_with_x0 */
    [RISCV_REG_V0] = { REG_VEC0 },  /* v0 */
    [RISCV_REG_V1] = { REG_VEC1 },  /* v1 */
    [RISCV_REG_V2] = { REG_VEC2 },  /* v2 */
    [RISCV_REG_V3] = { REG_VEC3 },  /* v3 */
    [RISCV_REG_V4] = { REG_VEC4 },  /* v4 */
    [RISCV_REG_V5] = { REG_VEC5 },  /* v5 */
    [RISCV_REG_V6] = { REG_VEC6 },  /* v6 */
    [RISCV_REG_V7] = { REG_VEC7 },  /* v7 */
    [RISCV_REG_V8] = { REG_VEC8 },  /* v8 */
    [RISCV_REG_V9] = { REG_VEC9 },  /* v9 */
    [RISCV_REG_V10] = { REG_VEC10 },  /* v10 */
    [RISCV_REG_V11] = { REG_VEC11 },  /* v11 */
    [RISCV_REG_V12] = { REG_VEC12 },  /* v12 */
    [RISCV_REG_V13] = { REG_VEC13 },  /* v13 */
    [RISCV_REG_V14] = { REG_VEC14 },  /* v14 */
    [RISCV_REG_V15] = { REG_VEC15 },  /* v15 */
    [RISCV_REG_V16] = { REG_VEC16 },  /* v16 */
    [RISCV_REG_V17] = { REG_VEC17 },  /* v17 */
    [RISCV_REG_V18] = { REG_VEC18 },  /* v18 */
    [RISCV_REG_V19] = { REG_VEC19 },  /* v19 */
    [RISCV_REG_V20] = { REG_VEC20 },  /* v20 */
    [RISCV_REG_V21] = { REG_VEC21 },  /* v21 */
    [RISCV_REG_V22] = { REG_VEC22 },  /* v22 */
    [RISCV_REG_V23] = { REG_VEC23 },  /* v23 */
    [RISCV_REG_V24] = { REG_VEC24 },  /* v24 */
    [RISCV_REG_V25] = { REG_VEC25 },  /* v25 */
    [RISCV_REG_V26] = { REG_VEC26 },  /* v26 */
    [RISCV_REG_V27] = { REG_VEC27 },  /* v27 */
    [RISCV_REG_V28] = { REG_VEC28 },  /* v28 */
    [RISCV_REG_V29] = { REG_VEC29 },  /* v29 */
    [RISCV_REG_V30] = { REG_VEC30 },  /* v30 */
    [RISCV_REG_V31] = { REG_VEC31 },  /* v31 */
    [RISCV_REG_X0] = { REG_ZERO },  /* x0 */
    [RISCV_REG_X1] = { REG_LR },  /* x1 */
    [RISCV_REG_X2] = { REG_SP },  /* x2 */
    [RISCV_REG_X3] = { REG_GPR3 },  /* x3 */
    [RISCV_REG_X4] = { REG_GPR4 },  /* x4 */
    [RISCV_REG_X5] = { REG_GPR5 },  /* x5 */
    [RISCV_REG_X6] = { REG_GPR6 },  /* x6 */
    [RISCV_REG_X7] = { REG_GPR7 },  /* x7 */
    [RISCV_REG_X8] = { REG_FP_REG },  /* x8 */
    [RISCV_REG_X9] = { REG_GPR9 },  /* x9 */
    [RISCV_REG_X10] = { REG_GPR10 },  /* x10 */
    [RISCV_REG_X11] = { REG_GPR11 },  /* x11 */
    [RISCV_REG_X12] = { REG_GPR12 },  /* x12 */
    [RISCV_REG_X13] = { REG_GPR13 },  /* x13 */
    [RISCV_REG_X14] = { REG_GPR14 },  /* x14 */
    [RISCV_REG_X15] = { REG_GPR15 },  /* x15 */
    [RISCV_REG_X16] = { REG_GPR16 },  /* x16 */
    [RISCV_REG_X17] = { REG_GPR17 },  /* x17 */
    [RISCV_REG_X18] = { REG_GPR18 },  /* x18 */
    [RISCV_REG_X19] = { REG_GPR19 },  /* x19 */
    [RISCV_REG_X20] = { REG_GPR20 },  /* x20 */
    [RISCV_REG_X21] = { REG_GPR21 },  /* x21 */
    [RISCV_REG_X22] = { REG_GPR22 },  /* x22 */
    [RISCV_REG_X23] = { REG_GPR23 },  /* x23 */
    [RISCV_REG_X24] = { REG_GPR24 },  /* x24 */
    [RISCV_REG_X25] = { REG_GPR25 },  /* x25 */
    [RISCV_REG_X26] = { REG_GPR26 },  /* x26 */
    [RISCV_REG_X27] = { REG_GPR27 },  /* x27 */
    [RISCV_REG_X28] = { REG_GPR28 },  /* x28 */
    [RISCV_REG_X29] = { REG_GPR29 },  /* x29 */
    [RISCV_REG_X30] = { REG_GPR30 },  /* x30 */
    [RISCV_REG_X31] = { REG_GPR31 },  /* x31 */
    [RISCV_REG_F0_D] = { REG_FPR0 },  /* f0_d */
    [RISCV_REG_F1_D] = { REG_FPR1 },  /* f1_d */
    [RISCV_REG_F2_D] = { REG_FPR2 },  /* f2_d */
    [RISCV_REG_F3_D] = { REG_FPR3 },  /* f3_d */
    [RISCV_REG_F4_D] = { REG_FPR4 },  /* f4_d */
    [RISCV_REG_F5_D] = { REG_FPR5 },  /* f5_d */
    [RISCV_REG_F6_D] = { REG_FPR6 },  /* f6_d */
    [RISCV_REG_F7_D] = { REG_FPR7 },  /* f7_d */
    [RISCV_REG_F8_D] = { REG_FPR8 },  /* f8_d */
    [RISCV_REG_F9_D] = { REG_FPR9 },  /* f9_d */
    [RISCV_REG_F10_D] = { REG_FPR10 },  /* f10_d */
    [RISCV_REG_F11_D] = { REG_FPR11 },  /* f11_d */
    [RISCV_REG_F12_D] = { REG_FPR12 },  /* f12_d */
    [RISCV_REG_F13_D] = { REG_FPR13 },  /* f13_d */
    [RISCV_REG_F14_D] = { REG_FPR14 },  /* f14_d */
    [RISCV_REG_F15_D] = { REG_FPR15 },  /* f15_d */
    [RISCV_REG_F16_D] = { REG_FPR16 },  /* f16_d */
    [RISCV_REG_F17_D] = { REG_FPR17 },  /* f17_d */
    [RISCV_REG_F18_D] = { REG_FPR18 },  /* f18_d */
    [RISCV_REG_F19_D] = { REG_FPR19 },  /* f19_d */
    [RISCV_REG_F20_D] = { REG_FPR20 },  /* f20_d */
    [RISCV_REG_F21_D] = { REG_FPR21 },  /* f21_d */
    [RISCV_REG_F22_D] = { REG_FPR22 },  /* f22_d */
    [RISCV_REG_F23_D] = { REG_FPR23 },  /* f23_d */
    [RISCV_REG_F24_D] = { REG_FPR24 },  /* f24_d */
    [RISCV_REG_F25_D] = { REG_FPR25 },  /* f25_d */
    [RISCV_REG_F26_D] = { REG_FPR26 },  /* f26_d */
    [RISCV_REG_F27_D] = { REG_FPR27 },  /* f27_d */
    [RISCV_REG_F28_D] = { REG_FPR28 },  /* f28_d */
    [RISCV_REG_F29_D] = { REG_FPR29 },  /* f29_d */
    [RISCV_REG_F30_D] = { REG_FPR30 },  /* f30_d */
    [RISCV_REG_F31_D] = { REG_FPR31 },  /* f31_d */
    [RISCV_REG_F0_F] = { REG_FPR0 },  /* f0_f */
    [RISCV_REG_F1_F] = { REG_FPR1 },  /* f1_f */
    [RISCV_REG_F2_F] = { REG_FPR2 },  /* f2_f */
    [RISCV_REG_F3_F] = { REG_FPR3 },  /* f3_f */
    [RISCV_REG_F4_F] = { REG_FPR4 },  /* f4_f */
    [RISCV_REG_F5_F] = { REG_FPR5 },  /* f5_f */
    [RISCV_REG_F6_F] = { REG_FPR6 },  /* f6_f */
    [RISCV_REG_F7_F] = { REG_FPR7 },  /* f7_f */
    [RISCV_REG_F8_F] = { REG_FPR8 },  /* f8_f */
    [RISCV_REG_F9_F] = { REG_FPR9 },  /* f9_f */
    [RISCV_REG_F10_F] = { REG_FPR10 },  /* f10_f */
    [RISCV_REG_F11_F] = { REG_FPR11 },  /* f11_f */
    [RISCV_REG_F12_F] = { REG_FPR12 },  /* f12_f */
    [RISCV_REG_F13_F] = { REG_FPR13 },  /* f13_f */
    [RISCV_REG_F14_F] = { REG_FPR14 },  /* f14_f */
    [RISCV_REG_F15_F] = { REG_FPR15 },  /* f15_f */
    [RISCV_REG_F16_F] = { REG_FPR16 },  /* f16_f */
    [RISCV_REG_F17_F] = { REG_FPR17 },  /* f17_f */
    [RISCV_REG_F18_F] = { REG_FPR18 },  /* f18_f */
    [RISCV_REG_F19_F] = { REG_FPR19 },  /* f19_f */
    [RISCV_REG_F20_F] = { REG_FPR20 },  /* f20_f */
    [RISCV_REG_F21_F] = { REG_FPR21 },  /* f21_f */
    [RISCV_REG_F22_F] = { REG_FPR22 },  /* f22_f */
    [RISCV_REG_F23_F] = { REG_FPR23 },  /* f23_f */
    [RISCV_REG_F24_F] = { REG_FPR24 },  /* f24_f */
    [RISCV_REG_F25_F] = { REG_FPR25 },  /* f25_f */
    [RISCV_REG_F26_F] = { REG_FPR26 },  /* f26_f */
    [RISCV_REG_F27_F] = { REG_FPR27 },  /* f27_f */
    [RISCV_REG_F28_F] = { REG_FPR28 },  /* f28_f */
    [RISCV_REG_F29_F] = { REG_FPR29 },  /* f29_f */
    [RISCV_REG_F30_F] = { REG_FPR30 },  /* f30_f */
    [RISCV_REG_F31_F] = { REG_FPR31 },  /* f31_f */
    [RISCV_REG_F0_H] = { REG_FPR0 },  /* f0_h */
    [RISCV_REG_F1_H] = { REG_FPR1 },  /* f1_h */
    [RISCV_REG_F2_H] = { REG_FPR2 },  /* f2_h */
    [RISCV_REG_F3_H] = { REG_FPR3 },  /* f3_h */
    [RISCV_REG_F4_H] = { REG_FPR4 },  /* f4_h */
    [RISCV_REG_F5_H] = { REG_FPR5 },  /* f5_h */
    [RISCV_REG_F6_H] = { REG_FPR6 },  /* f6_h */
    [RISCV_REG_F7_H] = { REG_FPR7 },  /* f7_h */
    [RISCV_REG_F8_H] = { REG_FPR8 },  /* f8_h */
    [RISCV_REG_F9_H] = { REG_FPR9 },  /* f9_h */
    [RISCV_REG_F10_H] = { REG_FPR10 },  /* f10_h */
    [RISCV_REG_F11_H] = { REG_FPR11 },  /* f11_h */
    [RISCV_REG_F12_H] = { REG_FPR12 },  /* f12_h */
    [RISCV_REG_F13_H] = { REG_FPR13 },  /* f13_h */
    [RISCV_REG_F14_H] = { REG_FPR14 },  /* f14_h */
    [RISCV_REG_F15_H] = { REG_FPR15 },  /* f15_h */
    [RISCV_REG_F16_H] = { REG_FPR16 },  /* f16_h */
    [RISCV_REG_F17_H] = { REG_FPR17 },  /* f17_h */
    [RISCV_REG_F18_H] = { REG_FPR18 },  /* f18_h */
    [RISCV_REG_F19_H] = { REG_FPR19 },  /* f19_h */
    [RISCV_REG_F20_H] = { REG_FPR20 },  /* f20_h */
    [RISCV_REG_F21_H] = { REG_FPR21 },  /* f21_h */
    [RISCV_REG_F22_H] = { REG_FPR22 },  /* f22_h */
    [RISCV_REG_F23_H] = { REG_FPR23 },  /* f23_h */
    [RISCV_REG_F24_H] = { REG_FPR24 },  /* f24_h */
    [RISCV_REG_F25_H] = { REG_FPR25 },  /* f25_h */
    [RISCV_REG_F26_H] = { REG_FPR26 },  /* f26_h */
    [RISCV_REG_F27_H] = { REG_FPR27 },  /* f27_h */
    [RISCV_REG_F28_H] = { REG_FPR28 },  /* f28_h */
    [RISCV_REG_F29_H] = { REG_FPR29 },  /* f29_h */
    [RISCV_REG_F30_H] = { REG_FPR30 },  /* f30_h */
    [RISCV_REG_F31_H] = { REG_FPR31 },  /* f31_h */
    [RISCV_REG_X0_PAIR] = { REG_ZERO },  /* x0_pair */
    [RISCV_REG_V0M2] = { REG_VEC0, 2, { REG_VEC0, REG_VEC1 } },  /* v0m2 */
    [RISCV_REG_V0M4] = { REG_VEC0, 4, { REG_VEC0, REG_VEC1, REG_VEC2, REG_VEC3 } },  /* v0m4 */
    [RISCV_REG_V0M8] = { REG_VEC0, 8, { REG_VEC0, REG_VEC1, REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7 } },  /* v0m8 */
    [RISCV_REG_V2M2] = { REG_VEC2, 2, { REG_VEC2, REG_VEC3 } },  /* v2m2 */
    [RISCV_REG_V4M2] = { REG_VEC4, 2, { REG_VEC4, REG_VEC5 } },  /* v4m2 */
    [RISCV_REG_V4M4] = { REG_VEC4, 4, { REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7 } },  /* v4m4 */
    [RISCV_REG_V6M2] = { REG_VEC6, 2, { REG_VEC6, REG_VEC7 } },  /* v6m2 */
    [RISCV_REG_V8M2] = { REG_VEC8, 2, { REG_VEC8, REG_VEC9 } },  /* v8m2 */
    [RISCV_REG_V8M4] = { REG_VEC8, 4, { REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11 } },  /* v8m4 */
    [RISCV_REG_V8M8] = { REG_VEC8, 8, { REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15 } },  /* v8m8 */
    [RISCV_REG_V10M2] = { REG_VEC10, 2, { REG_VEC10, REG_VEC11 } },  /* v10m2 */
    [RISCV_REG_V12M2] = { REG_VEC12, 2, { REG_VEC12, REG_VEC13 } },  /* v12m2 */
    [RISCV_REG_V12M4] = { REG_VEC12, 4, { REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15 } },  /* v12m4 */
    [RISCV_REG_V14M2] = { REG_VEC14, 2, { REG_VEC14, REG_VEC15 } },  /* v14m2 */
    [RISCV_REG_V16M2] = { REG_VEC16, 2, { REG_VEC16, REG_VEC17 } },  /* v16m2 */
    [RISCV_REG_V16M4] = { REG_VEC16, 4, { REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19 } },  /* v16m4 */
    [RISCV_REG_V16M8] = { REG_VEC16, 8, { REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23 } },  /* v16m8 */
    [RISCV_REG_V18M2] = { REG_VEC18, 2, { REG_VEC18, REG_VEC19 } },  /* v18m2 */
    [RISCV_REG_V20M2] = { REG_VEC20, 2, { REG_VEC20, REG_VEC21 } },  /* v20m2 */
    [RISCV_REG_V20M4] = { REG_VEC20, 4, { REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23 } },  /* v20m4 */
    [RISCV_REG_V22M2] = { REG_VEC22, 2, { REG_VEC22, REG_VEC23 } },  /* v22m2 */
    [RISCV_REG_V24M2] = { REG_VEC24, 2, { REG_VEC24, REG_VEC25 } },  /* v24m2 */
    [RISCV_REG_V24M4] = { REG_VEC24, 4, { REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27 } },  /* v24m4 */
    [RISCV_REG_V24M8] = { REG_VEC24, 8, { REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29, REG_VEC30, REG_VEC31 } },  /* v24m8 */
    [RISCV_REG_V26M2] = { REG_VEC26, 2, { REG_VEC26, REG_VEC27 } },  /* v26m2 */
    [RISCV_REG_V28M2] = { REG_VEC28, 2, { REG_VEC28, REG_VEC29 } },  /* v28m2 */
    [RISCV_REG_V28M4] = { REG_VEC28, 4, { REG_VEC28, REG_VEC29, REG_VEC30, REG_VEC31 } },  /* v28m4 */
    [RISCV_REG_V30M2] = { REG_VEC30, 2, { REG_VEC30, REG_VEC31 } },  /* v30m2 */
    [RISCV_REG_X2_X3] = { REG_SP, 2, { REG_SP, REG_GPR3 } },  /* x2_x3 */
    [RISCV_REG_X4_X5] = { REG_GPR4, 2, { REG_GPR4, REG_GPR5 } },  /* x4_x5 */
    [RISCV_REG_X6_X7] = { REG_GPR6, 2, { REG_GPR6, REG_GPR7 } },  /* x6_x7 */
    [RISCV_REG_X8_X9] = { REG_FP_REG, 2, { REG_FP_REG, REG_GPR9 } },  /* x8_x9 */
    [RISCV_REG_X10_X11] = { REG_GPR10, 2, { REG_GPR10, REG_GPR11 } },  /* x10_x11 */
    [RISCV_REG_X12_X13] = { REG_GPR12, 2, { REG_GPR12, REG_GPR13 } },  /* x12_x13 */
    [RISCV_REG_X14_X15] = { REG_GPR14, 2, { REG_GPR14, REG_GPR15 } },  /* x14_x15 */
    [RISCV_REG_X16_X17] = { REG_GPR16, 2, { REG_GPR16, REG_GPR17 } },  /* x16_x17 */
    [RISCV_REG_X18_X19] = { REG_GPR18, 2, { REG_GPR18, REG_GPR19 } },  /* x18_x19 */
    [RISCV_REG_X20_X21] = { REG_GPR20, 2, { REG_GPR20, REG_GPR21 } },  /* x20_x21 */
    [RISCV_REG_X22_X23] = { REG_GPR22, 2, { REG_GPR22, REG_GPR23 } },  /* x22_x23 */
    [RISCV_REG_X24_X25] = { REG_GPR24, 2, { REG_GPR24, REG_GPR25 } },  /* x24_x25 */
    [RISCV_REG_X26_X27] = { REG_GPR26, 2, { REG_GPR26, REG_GPR27 } },  /* x26_x27 */
    [RISCV_REG_X28_X29] = { REG_GPR28, 2, { REG_GPR28, REG_GPR29 } },  /* x28_x29 */
    [RISCV_REG_X30_X31] = { REG_GPR30, 2, { REG_GPR30, REG_GPR31 } },  /* x30_x31 */
    [RISCV_REG_V1_V2] = { REG_VEC1, 2, { REG_VEC1, REG_VEC2 } },  /* v1_v2 */
    [RISCV_REG_V2_V3] = { REG_VEC2, 2, { REG_VEC2, REG_VEC3 } },  /* v2_v3 */
    [RISCV_REG_V3_V4] = { REG_VEC3, 2, { REG_VEC3, REG_VEC4 } },  /* v3_v4 */
    [RISCV_REG_V4_V5] = { REG_VEC4, 2, { REG_VEC4, REG_VEC5 } },  /* v4_v5 */
    [RISCV_REG_V5_V6] = { REG_VEC5, 2, { REG_VEC5, REG_VEC6 } },  /* v5_v6 */
    [RISCV_REG_V6_V7] = { REG_VEC6, 2, { REG_VEC6, REG_VEC7 } },  /* v6_v7 */
    [RISCV_REG_V7_V8] = { REG_VEC7, 2, { REG_VEC7, REG_VEC8 } },  /* v7_v8 */
    [RISCV_REG_V8_V9] = { REG_VEC8, 2, { REG_VEC8, REG_VEC9 } },  /* v8_v9 */
    [RISCV_REG_V9_V10] = { REG_VEC9, 2, { REG_VEC9, REG_VEC10 } },  /* v9_v10 */
    [RISCV_REG_V10_V11] = { REG_VEC10, 2, { REG_VEC10, REG_VEC11 } },  /* v10_v11 */
    [RISCV_REG_V11_V12] = { REG_VEC11, 2, { REG_VEC11, REG_VEC12 } },  /* v11_v12 */
    [RISCV_REG_V12_V13] = { REG_VEC12, 2, { REG_VEC12, REG_VEC13 } },  /* v12_v13 */
    [RISCV_REG_V13_V14] = { REG_VEC13, 2, { REG_VEC13, REG_VEC14 } },  /* v13_v14 */
    [RISCV_REG_V14_V15] = { REG_VEC14, 2, { REG_VEC14, REG_VEC15 } },  /* v14_v15 */
    [RISCV_REG_V15_V16] = { REG_VEC15, 2, { REG_VEC15, REG_VEC16 } },  /* v15_v16 */
    [RISCV_REG_V16_V17] = { REG_VEC16, 2, { REG_VEC16, REG_VEC17 } },  /* v16_v17 */
    [RISCV_REG_V17_V18] = { REG_VEC17, 2, { REG_VEC17, REG_VEC18 } },  /* v17_v18 */
    [RISCV_REG_V18_V19] = { REG_VEC18, 2, { REG_VEC18, REG_VEC19 } },  /* v18_v19 */
    [RISCV_REG_V19_V20] = { REG_VEC19, 2, { REG_VEC19, REG_VEC20 } },  /* v19_v20 */
    [RISCV_REG_V20_V21] = { REG_VEC20, 2, { REG_VEC20, REG_VEC21 } },  /* v20_v21 */
    [RISCV_REG_V21_V22] = { REG_VEC21, 2, { REG_VEC21, REG_VEC22 } },  /* v21_v22 */
    [RISCV_REG_V22_V23] = { REG_VEC22, 2, { REG_VEC22, REG_VEC23 } },  /* v22_v23 */
    [RISCV_REG_V23_V24] = { REG_VEC23, 2, { REG_VEC23, REG_VEC24 } },  /* v23_v24 */
    [RISCV_REG_V24_V25] = { REG_VEC24, 2, { REG_VEC24, REG_VEC25 } },  /* v24_v25 */
    [RISCV_REG_V25_V26] = { REG_VEC25, 2, { REG_VEC25, REG_VEC26 } },  /* v25_v26 */
    [RISCV_REG_V26_V27] = { REG_VEC26, 2, { REG_VEC26, REG_VEC27 } },  /* v26_v27 */
    [RISCV_REG_V27_V28] = { REG_VEC27, 2, { REG_VEC27, REG_VEC28 } },  /* v27_v28 */
    [RISCV_REG_V28_V29] = { REG_VEC28, 2, { REG_VEC28, REG_VEC29 } },  /* v28_v29 */
    [RISCV_REG_V29_V30] = { REG_VEC29, 2, { REG_VEC29, REG_VEC30 } },  /* v29_v30 */
    [RISCV_REG_V30_V31] = { REG_VEC30, 2, { REG_VEC30, REG_VEC31 } },  /* v30_v31 */
    [RISCV_REG_V0_V1] = { REG_VEC0, 2, { REG_VEC0, REG_VEC1 } },  /* v0_v1 */
    [RISCV_REG_V2M2_V4M2] = { REG_VEC2, 4, { REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5 } },  /* v2m2_v4m2 */
    [RISCV_REG_V4M2_V6M2] = { REG_VEC4, 4, { REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7 } },  /* v4m2_v6m2 */
    [RISCV_REG_V6M2_V8M2] = { REG_VEC6, 4, { REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9 } },  /* v6m2_v8m2 */
    [RISCV_REG_V8M2_V10M2] = { REG_VEC8, 4, { REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11 } },  /* v8m2_v10m2 */
    [RISCV_REG_V10M2_V12M2] = { REG_VEC10, 4, { REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13 } },  /* v10m2_v12m2 */
    [RISCV_REG_V12M2_V14M2] = { REG_VEC12, 4, { REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15 } },  /* v12m2_v14m2 */
    [RISCV_REG_V14M2_V16M2] = { REG_VEC14, 4, { REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17 } },  /* v14m2_v16m2 */
    [RISCV_REG_V16M2_V18M2] = { REG_VEC16, 4, { REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19 } },  /* v16m2_v18m2 */
    [RISCV_REG_V18M2_V20M2] = { REG_VEC18, 4, { REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21 } },  /* v18m2_v20m2 */
    [RISCV_REG_V20M2_V22M2] = { REG_VEC20, 4, { REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23 } },  /* v20m2_v22m2 */
    [RISCV_REG_V22M2_V24M2] = { REG_VEC22, 4, { REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25 } },  /* v22m2_v24m2 */
    [RISCV_REG_V24M2_V26M2] = { REG_VEC24, 4, { REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27 } },  /* v24m2_v26m2 */
    [RISCV_REG_V26M2_V28M2] = { REG_VEC26, 4, { REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29 } },  /* v26m2_v28m2 */
    [RISCV_REG_V28M2_V30M2] = { REG_VEC28, 4, { REG_VEC28, REG_VEC29, REG_VEC30, REG_VEC31 } },  /* v28m2_v30m2 */
    [RISCV_REG_V0M2_V2M2] = { REG_VEC0, 4, { REG_VEC0, REG_VEC1, REG_VEC2, REG_VEC3 } },  /* v0m2_v2m2 */
    [RISCV_REG_V4M4_V8M4] = { REG_VEC4, 8, { REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11 } },  /* v4m4_v8m4 */
    [RISCV_REG_V8M4_V12M4] = { REG_VEC8, 8, { REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15 } },  /* v8m4_v12m4 */
    [RISCV_REG_V12M4_V16M4] = { REG_VEC12, 8, { REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19 } },  /* v12m4_v16m4 */
    [RISCV_REG_V16M4_V20M4] = { REG_VEC16, 8, { REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23 } },  /* v16m4_v20m4 */
    [RISCV_REG_V20M4_V24M4] = { REG_VEC20, 8, { REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27 } },  /* v20m4_v24m4 */
    [RISCV_REG_V24M4_V28M4] = { REG_VEC24, 8, { REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29, REG_VEC30, REG_VEC31 } },  /* v24m4_v28m4 */
    [RISCV_REG_V0M4_V4M4] = { REG_VEC0, 8, { REG_VEC0, REG_VEC1, REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7 } },  /* v0m4_v4m4 */
    [RISCV_REG_V1_V2_V3] = { REG_VEC1, 3, { REG_VEC1, REG_VEC2, REG_VEC3 } },  /* v1_v2_v3 */
    [RISCV_REG_V2_V3_V4] = { REG_VEC2, 3, { REG_VEC2, REG_VEC3, REG_VEC4 } },  /* v2_v3_v4 */
    [RISCV_REG_V3_V4_V5] = { REG_VEC3, 3, { REG_VEC3, REG_VEC4, REG_VEC5 } },  /* v3_v4_v5 */
    [RISCV_REG_V4_V5_V6] = { REG_VEC4, 3, { REG_VEC4, REG_VEC5, REG_VEC6 } },  /* v4_v5_v6 */
    [RISCV_REG_V5_V6_V7] = { REG_VEC5, 3, { REG_VEC5, REG_VEC6, REG_VEC7 } },  /* v5_v6_v7 */
    [RISCV_REG_V6_V7_V8] = { REG_VEC6, 3, { REG_VEC6, REG_VEC7, REG_VEC8 } },  /* v6_v7_v8 */
    [RISCV_REG_V7_V8_V9] = { REG_VEC7, 3, { REG_VEC7, REG_VEC8, REG_VEC9 } },  /* v7_v8_v9 */
    [RISCV_REG_V8_V9_V10] = { REG_VEC8, 3, { REG_VEC8, REG_VEC9, REG_VEC10 } },  /* v8_v9_v10 */
    [RISCV_REG_V9_V10_V11] = { REG_VEC9, 3, { REG_VEC9, REG_VEC10, REG_VEC11 } },  /* v9_v10_v11 */
    [RISCV_REG_V10_V11_V12] = { REG_VEC10, 3, { REG_VEC10, REG_VEC11, REG_VEC12 } },  /* v10_v11_v12 */
    [RISCV_REG_V11_V12_V13] = { REG_VEC11, 3, { REG_VEC11, REG_VEC12, REG_VEC13 } },  /* v11_v12_v13 */
    [RISCV_REG_V12_V13_V14] = { REG_VEC12, 3, { REG_VEC12, REG_VEC13, REG_VEC14 } },  /* v12_v13_v14 */
    [RISCV_REG_V13_V14_V15] = { REG_VEC13, 3, { REG_VEC13, REG_VEC14, REG_VEC15 } },  /* v13_v14_v15 */
    [RISCV_REG_V14_V15_V16] = { REG_VEC14, 3, { REG_VEC14, REG_VEC15, REG_VEC16 } },  /* v14_v15_v16 */
    [RISCV_REG_V15_V16_V17] = { REG_VEC15, 3, { REG_VEC15, REG_VEC16, REG_VEC17 } },  /* v15_v16_v17 */
    [RISCV_REG_V16_V17_V18] = { REG_VEC16, 3, { REG_VEC16, REG_VEC17, REG_VEC18 } },  /* v16_v17_v18 */
    [RISCV_REG_V17_V18_V19] = { REG_VEC17, 3, { REG_VEC17, REG_VEC18, REG_VEC19 } },  /* v17_v18_v19 */
    [RISCV_REG_V18_V19_V20] = { REG_VEC18, 3, { REG_VEC18, REG_VEC19, REG_VEC20 } },  /* v18_v19_v20 */
    [RISCV_REG_V19_V20_V21] = { REG_VEC19, 3, { REG_VEC19, REG_VEC20, REG_VEC21 } },  /* v19_v20_v21 */
    [RISCV_REG_V20_V21_V22] = { REG_VEC20, 3, { REG_VEC20, REG_VEC21, REG_VEC22 } },  /* v20_v21_v22 */
    [RISCV_REG_V21_V22_V23] = { REG_VEC21, 3, { REG_VEC21, REG_VEC22, REG_VEC23 } },  /* v21_v22_v23 */
    [RISCV_REG_V22_V23_V24] = { REG_VEC22, 3, { REG_VEC22, REG_VEC23, REG_VEC24 } },  /* v22_v23_v24 */
    [RISCV_REG_V23_V24_V25] = { REG_VEC23, 3, { REG_VEC23, REG_VEC24, REG_VEC25 } },  /* v23_v24_v25 */
    [RISCV_REG_V24_V25_V26] = { REG_VEC24, 3, { REG_VEC24, REG_VEC25, REG_VEC26 } },  /* v24_v25_v26 */
    [RISCV_REG_V25_V26_V27] = { REG_VEC25, 3, { REG_VEC25, REG_VEC26, REG_VEC27 } },  /* v25_v26_v27 */
    [RISCV_REG_V26_V27_V28] = { REG_VEC26, 3, { REG_VEC26, REG_VEC27, REG_VEC28 } },  /* v26_v27_v28 */
    [RISCV_REG_V27_V28_V29] = { REG_VEC27, 3, { REG_VEC27, REG_VEC28, REG_VEC29 } },  /* v27_v28_v29 */
    [RISCV_REG_V28_V29_V30] = { REG_VEC28, 3, { REG_VEC28, REG_VEC29, REG_VEC30 } },  /* v28_v29_v30 */
    [RISCV_REG_V29_V30_V31] = { REG_VEC29, 3, { REG_VEC29, REG_VEC30, REG_VEC31 } },  /* v29_v30_v31 */
    [RISCV_REG_V0_V1_V2] = { REG_VEC0, 3, { REG_VEC0, REG_VEC1, REG_VEC2 } },  /* v0_v1_v2 */
    [RISCV_REG_V2M2_V4M2_V6M2] = { REG_VEC2, 6, { REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7 } },  /* v2m2_v4m2_v6m2 */
    [RISCV_REG_V4M2_V6M2_V8M2] = { REG_VEC4, 6, { REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9 } },  /* v4m2_v6m2_v8m2 */
    [RISCV_REG_V6M2_V8M2_V10M2] = { REG_VEC6, 6, { REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11 } },  /* v6m2_v8m2_v10m2 */
    [RISCV_REG_V8M2_V10M2_V12M2] = { REG_VEC8, 6, { REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13 } },  /* v8m2_v10m2_v12m2 */
    [RISCV_REG_V10M2_V12M2_V14M2] = { REG_VEC10, 6, { REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15 } },  /* v10m2_v12m2_v14m2 */
    [RISCV_REG_V12M2_V14M2_V16M2] = { REG_VEC12, 6, { REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17 } },  /* v12m2_v14m2_v16m2 */
    [RISCV_REG_V14M2_V16M2_V18M2] = { REG_VEC14, 6, { REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19 } },  /* v14m2_v16m2_v18m2 */
    [RISCV_REG_V16M2_V18M2_V20M2] = { REG_VEC16, 6, { REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21 } },  /* v16m2_v18m2_v20m2 */
    [RISCV_REG_V18M2_V20M2_V22M2] = { REG_VEC18, 6, { REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23 } },  /* v18m2_v20m2_v22m2 */
    [RISCV_REG_V20M2_V22M2_V24M2] = { REG_VEC20, 6, { REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25 } },  /* v20m2_v22m2_v24m2 */
    [RISCV_REG_V22M2_V24M2_V26M2] = { REG_VEC22, 6, { REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27 } },  /* v22m2_v24m2_v26m2 */
    [RISCV_REG_V24M2_V26M2_V28M2] = { REG_VEC24, 6, { REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29 } },  /* v24m2_v26m2_v28m2 */
    [RISCV_REG_V26M2_V28M2_V30M2] = { REG_VEC26, 6, { REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29, REG_VEC30, REG_VEC31 } },  /* v26m2_v28m2_v30m2 */
    [RISCV_REG_V0M2_V2M2_V4M2] = { REG_VEC0, 6, { REG_VEC0, REG_VEC1, REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5 } },  /* v0m2_v2m2_v4m2 */
    [RISCV_REG_V1_V2_V3_V4] = { REG_VEC1, 4, { REG_VEC1, REG_VEC2, REG_VEC3, REG_VEC4 } },  /* v1_v2_v3_v4 */
    [RISCV_REG_V2_V3_V4_V5] = { REG_VEC2, 4, { REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5 } },  /* v2_v3_v4_v5 */
    [RISCV_REG_V3_V4_V5_V6] = { REG_VEC3, 4, { REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6 } },  /* v3_v4_v5_v6 */
    [RISCV_REG_V4_V5_V6_V7] = { REG_VEC4, 4, { REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7 } },  /* v4_v5_v6_v7 */
    [RISCV_REG_V5_V6_V7_V8] = { REG_VEC5, 4, { REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8 } },  /* v5_v6_v7_v8 */
    [RISCV_REG_V6_V7_V8_V9] = { REG_VEC6, 4, { REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9 } },  /* v6_v7_v8_v9 */
    [RISCV_REG_V7_V8_V9_V10] = { REG_VEC7, 4, { REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10 } },  /* v7_v8_v9_v10 */
    [RISCV_REG_V8_V9_V10_V11] = { REG_VEC8, 4, { REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11 } },  /* v8_v9_v10_v11 */
    [RISCV_REG_V9_V10_V11_V12] = { REG_VEC9, 4, { REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12 } },  /* v9_v10_v11_v12 */
    [RISCV_REG_V10_V11_V12_V13] = { REG_VEC10, 4, { REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13 } },  /* v10_v11_v12_v13 */
    [RISCV_REG_V11_V12_V13_V14] = { REG_VEC11, 4, { REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14 } },  /* v11_v12_v13_v14 */
    [RISCV_REG_V12_V13_V14_V15] = { REG_VEC12, 4, { REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15 } },  /* v12_v13_v14_v15 */
    [RISCV_REG_V13_V14_V15_V16] = { REG_VEC13, 4, { REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16 } },  /* v13_v14_v15_v16 */
    [RISCV_REG_V14_V15_V16_V17] = { REG_VEC14, 4, { REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17 } },  /* v14_v15_v16_v17 */
    [RISCV_REG_V15_V16_V17_V18] = { REG_VEC15, 4, { REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18 } },  /* v15_v16_v17_v18 */
    [RISCV_REG_V16_V17_V18_V19] = { REG_VEC16, 4, { REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19 } },  /* v16_v17_v18_v19 */
    [RISCV_REG_V17_V18_V19_V20] = { REG_VEC17, 4, { REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20 } },  /* v17_v18_v19_v20 */
    [RISCV_REG_V18_V19_V20_V21] = { REG_VEC18, 4, { REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21 } },  /* v18_v19_v20_v21 */
    [RISCV_REG_V19_V20_V21_V22] = { REG_VEC19, 4, { REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22 } },  /* v19_v20_v21_v22 */
    [RISCV_REG_V20_V21_V22_V23] = { REG_VEC20, 4, { REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23 } },  /* v20_v21_v22_v23 */
    [RISCV_REG_V21_V22_V23_V24] = { REG_VEC21, 4, { REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24 } },  /* v21_v22_v23_v24 */
    [RISCV_REG_V22_V23_V24_V25] = { REG_VEC22, 4, { REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25 } },  /* v22_v23_v24_v25 */
    [RISCV_REG_V23_V24_V25_V26] = { REG_VEC23, 4, { REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26 } },  /* v23_v24_v25_v26 */
    [RISCV_REG_V24_V25_V26_V27] = { REG_VEC24, 4, { REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27 } },  /* v24_v25_v26_v27 */
    [RISCV_REG_V25_V26_V27_V28] = { REG_VEC25, 4, { REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28 } },  /* v25_v26_v27_v28 */
    [RISCV_REG_V26_V27_V28_V29] = { REG_VEC26, 4, { REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29 } },  /* v26_v27_v28_v29 */
    [RISCV_REG_V27_V28_V29_V30] = { REG_VEC27, 4, { REG_VEC27, REG_VEC28, REG_VEC29, REG_VEC30 } },  /* v27_v28_v29_v30 */
    [RISCV_REG_V28_V29_V30_V31] = { REG_VEC28, 4, { REG_VEC28, REG_VEC29, REG_VEC30, REG_VEC31 } },  /* v28_v29_v30_v31 */
    [RISCV_REG_V0_V1_V2_V3] = { REG_VEC0, 4, { REG_VEC0, REG_VEC1, REG_VEC2, REG_VEC3 } },  /* v0_v1_v2_v3 */
    [RISCV_REG_V2M2_V4M2_V6M2_V8M2] = { REG_VEC2, 8, { REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9 } },  /* v2m2_v4m2_v6m2_v8m2 */
    [RISCV_REG_V4M2_V6M2_V8M2_V10M2] = { REG_VEC4, 8, { REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11 } },  /* v4m2_v6m2_v8m2_v10m2 */
    [RISCV_REG_V6M2_V8M2_V10M2_V12M2] = { REG_VEC6, 8, { REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13 } },  /* v6m2_v8m2_v10m2_v12m2 */
    [RISCV_REG_V8M2_V10M2_V12M2_V14M2] = { REG_VEC8, 8, { REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15 } },  /* v8m2_v10m2_v12m2_v14m2 */
    [RISCV_REG_V10M2_V12M2_V14M2_V16M2] = { REG_VEC10, 8, { REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17 } },  /* v10m2_v12m2_v14m2_v16m2 */
    [RISCV_REG_V12M2_V14M2_V16M2_V18M2] = { REG_VEC12, 8, { REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19 } },  /* v12m2_v14m2_v16m2_v18m2 */
    [RISCV_REG_V14M2_V16M2_V18M2_V20M2] = { REG_VEC14, 8, { REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21 } },  /* v14m2_v16m2_v18m2_v20m2 */
    [RISCV_REG_V16M2_V18M2_V20M2_V22M2] = { REG_VEC16, 8, { REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23 } },  /* v16m2_v18m2_v20m2_v22m2 */
    [RISCV_REG_V18M2_V20M2_V22M2_V24M2] = { REG_VEC18, 8, { REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25 } },  /* v18m2_v20m2_v22m2_v24m2 */
    [RISCV_REG_V20M2_V22M2_V24M2_V26M2] = { REG_VEC20, 8, { REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27 } },  /* v20m2_v22m2_v24m2_v26m2 */
    [RISCV_REG_V22M2_V24M2_V26M2_V28M2] = { REG_VEC22, 8, { REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29 } },  /* v22m2_v24m2_v26m2_v28m2 */
    [RISCV_REG_V24M2_V26M2_V28M2_V30M2] = { REG_VEC24, 8, { REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29, REG_VEC30, REG_VEC31 } },  /* v24m2_v26m2_v28m2_v30m2 */
    [RISCV_REG_V0M2_V2M2_V4M2_V6M2] = { REG_VEC0, 8, { REG_VEC0, REG_VEC1, REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7 } },  /* v0m2_v2m2_v4m2_v6m2 */
    [RISCV_REG_V1_V2_V3_V4_V5] = { REG_VEC1, 5, { REG_VEC1, REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5 } },  /* v1_v2_v3_v4_v5 */
    [RISCV_REG_V2_V3_V4_V5_V6] = { REG_VEC2, 5, { REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6 } },  /* v2_v3_v4_v5_v6 */
    [RISCV_REG_V3_V4_V5_V6_V7] = { REG_VEC3, 5, { REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7 } },  /* v3_v4_v5_v6_v7 */
    [RISCV_REG_V4_V5_V6_V7_V8] = { REG_VEC4, 5, { REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8 } },  /* v4_v5_v6_v7_v8 */
    [RISCV_REG_V5_V6_V7_V8_V9] = { REG_VEC5, 5, { REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9 } },  /* v5_v6_v7_v8_v9 */
    [RISCV_REG_V6_V7_V8_V9_V10] = { REG_VEC6, 5, { REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10 } },  /* v6_v7_v8_v9_v10 */
    [RISCV_REG_V7_V8_V9_V10_V11] = { REG_VEC7, 5, { REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11 } },  /* v7_v8_v9_v10_v11 */
    [RISCV_REG_V8_V9_V10_V11_V12] = { REG_VEC8, 5, { REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12 } },  /* v8_v9_v10_v11_v12 */
    [RISCV_REG_V9_V10_V11_V12_V13] = { REG_VEC9, 5, { REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13 } },  /* v9_v10_v11_v12_v13 */
    [RISCV_REG_V10_V11_V12_V13_V14] = { REG_VEC10, 5, { REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14 } },  /* v10_v11_v12_v13_v14 */
    [RISCV_REG_V11_V12_V13_V14_V15] = { REG_VEC11, 5, { REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15 } },  /* v11_v12_v13_v14_v15 */
    [RISCV_REG_V12_V13_V14_V15_V16] = { REG_VEC12, 5, { REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16 } },  /* v12_v13_v14_v15_v16 */
    [RISCV_REG_V13_V14_V15_V16_V17] = { REG_VEC13, 5, { REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17 } },  /* v13_v14_v15_v16_v17 */
    [RISCV_REG_V14_V15_V16_V17_V18] = { REG_VEC14, 5, { REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18 } },  /* v14_v15_v16_v17_v18 */
    [RISCV_REG_V15_V16_V17_V18_V19] = { REG_VEC15, 5, { REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19 } },  /* v15_v16_v17_v18_v19 */
    [RISCV_REG_V16_V17_V18_V19_V20] = { REG_VEC16, 5, { REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20 } },  /* v16_v17_v18_v19_v20 */
    [RISCV_REG_V17_V18_V19_V20_V21] = { REG_VEC17, 5, { REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21 } },  /* v17_v18_v19_v20_v21 */
    [RISCV_REG_V18_V19_V20_V21_V22] = { REG_VEC18, 5, { REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22 } },  /* v18_v19_v20_v21_v22 */
    [RISCV_REG_V19_V20_V21_V22_V23] = { REG_VEC19, 5, { REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23 } },  /* v19_v20_v21_v22_v23 */
    [RISCV_REG_V20_V21_V22_V23_V24] = { REG_VEC20, 5, { REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24 } },  /* v20_v21_v22_v23_v24 */
    [RISCV_REG_V21_V22_V23_V24_V25] = { REG_VEC21, 5, { REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25 } },  /* v21_v22_v23_v24_v25 */
    [RISCV_REG_V22_V23_V24_V25_V26] = { REG_VEC22, 5, { REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26 } },  /* v22_v23_v24_v25_v26 */
    [RISCV_REG_V23_V24_V25_V26_V27] = { REG_VEC23, 5, { REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27 } },  /* v23_v24_v25_v26_v27 */
    [RISCV_REG_V24_V25_V26_V27_V28] = { REG_VEC24, 5, { REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28 } },  /* v24_v25_v26_v27_v28 */
    [RISCV_REG_V25_V26_V27_V28_V29] = { REG_VEC25, 5, { REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29 } },  /* v25_v26_v27_v28_v29 */
    [RISCV_REG_V26_V27_V28_V29_V30] = { REG_VEC26, 5, { REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29, REG_VEC30 } },  /* v26_v27_v28_v29_v30 */
    [RISCV_REG_V27_V28_V29_V30_V31] = { REG_VEC27, 5, { REG_VEC27, REG_VEC28, REG_VEC29, REG_VEC30, REG_VEC31 } },  /* v27_v28_v29_v30_v31 */
    [RISCV_REG_V0_V1_V2_V3_V4] = { REG_VEC0, 5, { REG_VEC0, REG_VEC1, REG_VEC2, REG_VEC3, REG_VEC4 } },  /* v0_v1_v2_v3_v4 */
    [RISCV_REG_V1_V2_V3_V4_V5_V6] = { REG_VEC1, 6, { REG_VEC1, REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6 } },  /* v1_v2_v3_v4_v5_v6 */
    [RISCV_REG_V2_V3_V4_V5_V6_V7] = { REG_VEC2, 6, { REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7 } },  /* v2_v3_v4_v5_v6_v7 */
    [RISCV_REG_V3_V4_V5_V6_V7_V8] = { REG_VEC3, 6, { REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8 } },  /* v3_v4_v5_v6_v7_v8 */
    [RISCV_REG_V4_V5_V6_V7_V8_V9] = { REG_VEC4, 6, { REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9 } },  /* v4_v5_v6_v7_v8_v9 */
    [RISCV_REG_V5_V6_V7_V8_V9_V10] = { REG_VEC5, 6, { REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10 } },  /* v5_v6_v7_v8_v9_v10 */
    [RISCV_REG_V6_V7_V8_V9_V10_V11] = { REG_VEC6, 6, { REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11 } },  /* v6_v7_v8_v9_v10_v11 */
    [RISCV_REG_V7_V8_V9_V10_V11_V12] = { REG_VEC7, 6, { REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12 } },  /* v7_v8_v9_v10_v11_v12 */
    [RISCV_REG_V8_V9_V10_V11_V12_V13] = { REG_VEC8, 6, { REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13 } },  /* v8_v9_v10_v11_v12_v13 */
    [RISCV_REG_V9_V10_V11_V12_V13_V14] = { REG_VEC9, 6, { REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14 } },  /* v9_v10_v11_v12_v13_v14 */
    [RISCV_REG_V10_V11_V12_V13_V14_V15] = { REG_VEC10, 6, { REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15 } },  /* v10_v11_v12_v13_v14_v15 */
    [RISCV_REG_V11_V12_V13_V14_V15_V16] = { REG_VEC11, 6, { REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16 } },  /* v11_v12_v13_v14_v15_v16 */
    [RISCV_REG_V12_V13_V14_V15_V16_V17] = { REG_VEC12, 6, { REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17 } },  /* v12_v13_v14_v15_v16_v17 */
    [RISCV_REG_V13_V14_V15_V16_V17_V18] = { REG_VEC13, 6, { REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18 } },  /* v13_v14_v15_v16_v17_v18 */
    [RISCV_REG_V14_V15_V16_V17_V18_V19] = { REG_VEC14, 6, { REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19 } },  /* v14_v15_v16_v17_v18_v19 */
    [RISCV_REG_V15_V16_V17_V18_V19_V20] = { REG_VEC15, 6, { REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20 } },  /* v15_v16_v17_v18_v19_v20 */
    [RISCV_REG_V16_V17_V18_V19_V20_V21] = { REG_VEC16, 6, { REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21 } },  /* v16_v17_v18_v19_v20_v21 */
    [RISCV_REG_V17_V18_V19_V20_V21_V22] = { REG_VEC17, 6, { REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22 } },  /* v17_v18_v19_v20_v21_v22 */
    [RISCV_REG_V18_V19_V20_V21_V22_V23] = { REG_VEC18, 6, { REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23 } },  /* v18_v19_v20_v21_v22_v23 */
    [RISCV_REG_V19_V20_V21_V22_V23_V24] = { REG_VEC19, 6, { REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24 } },  /* v19_v20_v21_v22_v23_v24 */
    [RISCV_REG_V20_V21_V22_V23_V24_V25] = { REG_VEC20, 6, { REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25 } },  /* v20_v21_v22_v23_v24_v25 */
    [RISCV_REG_V21_V22_V23_V24_V25_V26] = { REG_VEC21, 6, { REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26 } },  /* v21_v22_v23_v24_v25_v26 */
    [RISCV_REG_V22_V23_V24_V25_V26_V27] = { REG_VEC22, 6, { REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27 } },  /* v22_v23_v24_v25_v26_v27 */
    [RISCV_REG_V23_V24_V25_V26_V27_V28] = { REG_VEC23, 6, { REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28 } },  /* v23_v24_v25_v26_v27_v28 */
    [RISCV_REG_V24_V25_V26_V27_V28_V29] = { REG_VEC24, 6, { REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29 } },  /* v24_v25_v26_v27_v28_v29 */
    [RISCV_REG_V25_V26_V27_V28_V29_V30] = { REG_VEC25, 6, { REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29, REG_VEC30 } },  /* v25_v26_v27_v28_v29_v30 */
    [RISCV_REG_V26_V27_V28_V29_V30_V31] = { REG_VEC26, 6, { REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29, REG_VEC30, REG_VEC31 } },  /* v26_v27_v28_v29_v30_v31 */
    [RISCV_REG_V0_V1_V2_V3_V4_V5] = { REG_VEC0, 6, { REG_VEC0, REG_VEC1, REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5 } },  /* v0_v1_v2_v3_v4_v5 */
    [RISCV_REG_V1_V2_V3_V4_V5_V6_V7] = { REG_VEC1, 7, { REG_VEC1, REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7 } },  /* v1_v2_v3_v4_v5_v6_v7 */
    [RISCV_REG_V2_V3_V4_V5_V6_V7_V8] = { REG_VEC2, 7, { REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8 } },  /* v2_v3_v4_v5_v6_v7_v8 */
    [RISCV_REG_V3_V4_V5_V6_V7_V8_V9] = { REG_VEC3, 7, { REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9 } },  /* v3_v4_v5_v6_v7_v8_v9 */
    [RISCV_REG_V4_V5_V6_V7_V8_V9_V10] = { REG_VEC4, 7, { REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10 } },  /* v4_v5_v6_v7_v8_v9_v10 */
    [RISCV_REG_V5_V6_V7_V8_V9_V10_V11] = { REG_VEC5, 7, { REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11 } },  /* v5_v6_v7_v8_v9_v10_v11 */
    [RISCV_REG_V6_V7_V8_V9_V10_V11_V12] = { REG_VEC6, 7, { REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12 } },  /* v6_v7_v8_v9_v10_v11_v12 */
    [RISCV_REG_V7_V8_V9_V10_V11_V12_V13] = { REG_VEC7, 7, { REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13 } },  /* v7_v8_v9_v10_v11_v12_v13 */
    [RISCV_REG_V8_V9_V10_V11_V12_V13_V14] = { REG_VEC8, 7, { REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14 } },  /* v8_v9_v10_v11_v12_v13_v14 */
    [RISCV_REG_V9_V10_V11_V12_V13_V14_V15] = { REG_VEC9, 7, { REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15 } },  /* v9_v10_v11_v12_v13_v14_v15 */
    [RISCV_REG_V10_V11_V12_V13_V14_V15_V16] = { REG_VEC10, 7, { REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16 } },  /* v10_v11_v12_v13_v14_v15_v16 */
    [RISCV_REG_V11_V12_V13_V14_V15_V16_V17] = { REG_VEC11, 7, { REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17 } },  /* v11_v12_v13_v14_v15_v16_v17 */
    [RISCV_REG_V12_V13_V14_V15_V16_V17_V18] = { REG_VEC12, 7, { REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18 } },  /* v12_v13_v14_v15_v16_v17_v18 */
    [RISCV_REG_V13_V14_V15_V16_V17_V18_V19] = { REG_VEC13, 7, { REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19 } },  /* v13_v14_v15_v16_v17_v18_v19 */
    [RISCV_REG_V14_V15_V16_V17_V18_V19_V20] = { REG_VEC14, 7, { REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20 } },  /* v14_v15_v16_v17_v18_v19_v20 */
    [RISCV_REG_V15_V16_V17_V18_V19_V20_V21] = { REG_VEC15, 7, { REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21 } },  /* v15_v16_v17_v18_v19_v20_v21 */
    [RISCV_REG_V16_V17_V18_V19_V20_V21_V22] = { REG_VEC16, 7, { REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22 } },  /* v16_v17_v18_v19_v20_v21_v22 */
    [RISCV_REG_V17_V18_V19_V20_V21_V22_V23] = { REG_VEC17, 7, { REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23 } },  /* v17_v18_v19_v20_v21_v22_v23 */
    [RISCV_REG_V18_V19_V20_V21_V22_V23_V24] = { REG_VEC18, 7, { REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24 } },  /* v18_v19_v20_v21_v22_v23_v24 */
    [RISCV_REG_V19_V20_V21_V22_V23_V24_V25] = { REG_VEC19, 7, { REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25 } },  /* v19_v20_v21_v22_v23_v24_v25 */
    [RISCV_REG_V20_V21_V22_V23_V24_V25_V26] = { REG_VEC20, 7, { REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26 } },  /* v20_v21_v22_v23_v24_v25_v26 */
    [RISCV_REG_V21_V22_V23_V24_V25_V26_V27] = { REG_VEC21, 7, { REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27 } },  /* v21_v22_v23_v24_v25_v26_v27 */
    [RISCV_REG_V22_V23_V24_V25_V26_V27_V28] = { REG_VEC22, 7, { REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28 } },  /* v22_v23_v24_v25_v26_v27_v28 */
    [RISCV_REG_V23_V24_V25_V26_V27_V28_V29] = { REG_VEC23, 7, { REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29 } },  /* v23_v24_v25_v26_v27_v28_v29 */
    [RISCV_REG_V24_V25_V26_V27_V28_V29_V30] = { REG_VEC24, 7, { REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29, REG_VEC30 } },  /* v24_v25_v26_v27_v28_v29_v30 */
    [RISCV_REG_V25_V26_V27_V28_V29_V30_V31] = { REG_VEC25, 7, { REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29, REG_VEC30, REG_VEC31 } },  /* v25_v26_v27_v28_v29_v30_v31 */
    [RISCV_REG_V0_V1_V2_V3_V4_V5_V6] = { REG_VEC0, 7, { REG_VEC0, REG_VEC1, REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6 } },  /* v0_v1_v2_v3_v4_v5_v6 */
    [RISCV_REG_V1_V2_V3_V4_V5_V6_V7_V8] = { REG_VEC1, 8, { REG_VEC1, REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8 } },  /* v1_v2_v3_v4_v5_v6_v7_v8 */
    [RISCV_REG_V2_V3_V4_V5_V6_V7_V8_V9] = { REG_VEC2, 8, { REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9 } },  /* v2_v3_v4_v5_v6_v7_v8_v9 */
    [RISCV_REG_V3_V4_V5_V6_V7_V8_V9_V10] = { REG_VEC3, 8, { REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10 } },  /* v3_v4_v5_v6_v7_v8_v9_v10 */
    [RISCV_REG_V4_V5_V6_V7_V8_V9_V10_V11] = { REG_VEC4, 8, { REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11 } },  /* v4_v5_v6_v7_v8_v9_v10_v11 */
    [RISCV_REG_V5_V6_V7_V8_V9_V10_V11_V12] = { REG_VEC5, 8, { REG_VEC5, REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12 } },  /* v5_v6_v7_v8_v9_v10_v11_v12 */
    [RISCV_REG_V6_V7_V8_V9_V10_V11_V12_V13] = { REG_VEC6, 8, { REG_VEC6, REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13 } },  /* v6_v7_v8_v9_v10_v11_v12_v13 */
    [RISCV_REG_V7_V8_V9_V10_V11_V12_V13_V14] = { REG_VEC7, 8, { REG_VEC7, REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14 } },  /* v7_v8_v9_v10_v11_v12_v13_v14 */
    [RISCV_REG_V8_V9_V10_V11_V12_V13_V14_V15] = { REG_VEC8, 8, { REG_VEC8, REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15 } },  /* v8_v9_v10_v11_v12_v13_v14_v15 */
    [RISCV_REG_V9_V10_V11_V12_V13_V14_V15_V16] = { REG_VEC9, 8, { REG_VEC9, REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16 } },  /* v9_v10_v11_v12_v13_v14_v15_v16 */
    [RISCV_REG_V10_V11_V12_V13_V14_V15_V16_V17] = { REG_VEC10, 8, { REG_VEC10, REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17 } },  /* v10_v11_v12_v13_v14_v15_v16_v17 */
    [RISCV_REG_V11_V12_V13_V14_V15_V16_V17_V18] = { REG_VEC11, 8, { REG_VEC11, REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18 } },  /* v11_v12_v13_v14_v15_v16_v17_v18 */
    [RISCV_REG_V12_V13_V14_V15_V16_V17_V18_V19] = { REG_VEC12, 8, { REG_VEC12, REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19 } },  /* v12_v13_v14_v15_v16_v17_v18_v19 */
    [RISCV_REG_V13_V14_V15_V16_V17_V18_V19_V20] = { REG_VEC13, 8, { REG_VEC13, REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20 } },  /* v13_v14_v15_v16_v17_v18_v19_v20 */
    [RISCV_REG_V14_V15_V16_V17_V18_V19_V20_V21] = { REG_VEC14, 8, { REG_VEC14, REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21 } },  /* v14_v15_v16_v17_v18_v19_v20_v21 */
    [RISCV_REG_V15_V16_V17_V18_V19_V20_V21_V22] = { REG_VEC15, 8, { REG_VEC15, REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22 } },  /* v15_v16_v17_v18_v19_v20_v21_v22 */
    [RISCV_REG_V16_V17_V18_V19_V20_V21_V22_V23] = { REG_VEC16, 8, { REG_VEC16, REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23 } },  /* v16_v17_v18_v19_v20_v21_v22_v23 */
    [RISCV_REG_V17_V18_V19_V20_V21_V22_V23_V24] = { REG_VEC17, 8, { REG_VEC17, REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24 } },  /* v17_v18_v19_v20_v21_v22_v23_v24 */
    [RISCV_REG_V18_V19_V20_V21_V22_V23_V24_V25] = { REG_VEC18, 8, { REG_VEC18, REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25 } },  /* v18_v19_v20_v21_v22_v23_v24_v25 */
    [RISCV_REG_V19_V20_V21_V22_V23_V24_V25_V26] = { REG_VEC19, 8, { REG_VEC19, REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26 } },  /* v19_v20_v21_v22_v23_v24_v25_v26 */
    [RISCV_REG_V20_V21_V22_V23_V24_V25_V26_V27] = { REG_VEC20, 8, { REG_VEC20, REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27 } },  /* v20_v21_v22_v23_v24_v25_v26_v27 */
    [RISCV_REG_V21_V22_V23_V24_V25_V26_V27_V28] = { REG_VEC21, 8, { REG_VEC21, REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28 } },  /* v21_v22_v23_v24_v25_v26_v27_v28 */
    [RISCV_REG_V22_V23_V24_V25_V26_V27_V28_V29] = { REG_VEC22, 8, { REG_VEC22, REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29 } },  /* v22_v23_v24_v25_v26_v27_v28_v29 */
    [RISCV_REG_V23_V24_V25_V26_V27_V28_V29_V30] = { REG_VEC23, 8, { REG_VEC23, REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29, REG_VEC30 } },  /* v23_v24_v25_v26_v27_v28_v29_v30 */
    [RISCV_REG_V24_V25_V26_V27_V28_V29_V30_V31] = { REG_VEC24, 8, { REG_VEC24, REG_VEC25, REG_VEC26, REG_VEC27, REG_VEC28, REG_VEC29, REG_VEC30, REG_VEC31 } },  /* v24_v25_v26_v27_v28_v29_v30_v31 */
    [RISCV_REG_V0_V1_V2_V3_V4_V5_V6_V7] = { REG_VEC0, 8, { REG_VEC0, REG_VEC1, REG_VEC2, REG_VEC3, REG_VEC4, REG_VEC5, REG_VEC6, REG_VEC7 } },  /* v0_v1_v2_v3_v4_v5_v6_v7 */
};
...
static const InsnClassification riscv_insn_class[RISCV_INS_ENDING] = {
    ...
    [RISCV_INS_CALL]                      = { GEN_OP_CALL,   BRANCH_DIRECT_CALL,    MF_NONE },
    ...
    [RISCV_INS_TAIL]                      = { GEN_OP_CALL,   BRANCH_DIRECT_CALL,    MF_NONE },
    ...
    [RISCV_INS_AUIPC]                     = { GEN_OP_INT_ADD, BRANCH_NONE,           MF_NONE },
    ...
    [RISCV_INS_CM_JALT]                   = { GEN_OP_CALL,   BRANCH_INDIRECT_CALL,  MF_NONE },
    ...
    [RISCV_INS_JAL]                       = { GEN_OP_CALL,   BRANCH_DIRECT_CALL,    MF_NONE,
                                        .refine = refine_riscv_direct_jal },

                                 ...
                                 const Stats &stats)
{
    const struct { const char *name; uint64_t value; } counters[] = {
        ...
        { "CP segment-open memops dropped",      stats.cp_open_leak_memops_dropped },
        { "CP impossible-slot memops",           stats.cp_impossible_slot_memops },
        { "Memops over slot ceiling",            stats.memops_over_slot_ceiling },
        { "Memops over template max",            stats.memops_over_template_max },
        ...
        { "REP register writes deferred to completion",     stats.rep_reg_writes_deferred },
        ...
        { "  ...marker unreadable, in kernel",   stats.refresh_unreadable_in_kernel },
        { "  ...marker unreadable, in user",     stats.refresh_unreadable_in_user },
        { "  ...marker readable, content differs", stats.refresh_content_mismatch },
        { "gate refresh turned the gate OFF",    stats.refresh_gate_turned_off },
        { "gate refresh turned the gate ON",     stats.refresh_gate_turned_on },
        ...
        { "MOPS bytes mismatch (must be 0)",     stats.mops_bytes_mismatch },
        ...
        { "  seating: loads associated by a stated register",
                                                 qdep_counters()->load_datum_stated },
        { "  seating: loads partly associated by a stated register",
                                                 qdep_counters()->load_datum_partial },
        { "  seating: dependency blocks withdrawn, mask position past its width",
                                           qdep_counters()->mask_bit_unplaceable },

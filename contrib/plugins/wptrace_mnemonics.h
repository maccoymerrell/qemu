...
static const MnemonicEntry x86_mnemonic_table[] = {
    ...
    MNEM("xchgb",   GEN_OP_XCHG, BRANCH_NONE, MF_NONE, WPT_OP_RE_STD, CAP_RW_REG_OR_MEM, CAP_RW_REG_OR_MEM, CAP_NONE, CAP_NONE),
    MNEM("xchgw",   GEN_OP_XCHG, BRANCH_NONE, MF_NONE, WPT_OP_RE_STD, CAP_RW_REG_OR_MEM, CAP_RW_REG_OR_MEM, CAP_NONE, CAP_NONE),
    MNEM("xchgl",   GEN_OP_XCHG, BRANCH_NONE, MF_NONE, WPT_OP_RE_STD, CAP_RW_REG_OR_MEM, CAP_RW_REG_OR_MEM, CAP_NONE, CAP_NONE),
    MNEM("xchgq",   GEN_OP_XCHG, BRANCH_NONE, MF_NONE, WPT_OP_RE_STD, CAP_RW_REG_OR_MEM, CAP_RW_REG_OR_MEM, CAP_NONE, CAP_NONE),
    /* Comparison suffixed */
    ...
    MNEM_I("cmpxchgb", GEN_OP_XCHG, BRANCH_NONE, F_CMP, WPT_OP_RE_STD, CAP_SRC_REG_OR_MEM, CAP_RW_REG_OR_MEM, CAP_NONE, CAP_NONE, I_AX, I_AX),
    MNEM_I("cmpxchgw", GEN_OP_XCHG, BRANCH_NONE, F_CMP, WPT_OP_RE_STD, CAP_SRC_REG_OR_MEM, CAP_RW_REG_OR_MEM, CAP_NONE, CAP_NONE, I_AX, I_AX),
    MNEM_I("cmpxchgl", GEN_OP_XCHG, BRANCH_NONE, F_CMP, WPT_OP_RE_STD, CAP_SRC_REG_OR_MEM, CAP_RW_REG_OR_MEM, CAP_NONE, CAP_NONE, I_AX, I_AX),
    MNEM_I("cmpxchgq", GEN_OP_XCHG, BRANCH_NONE, F_CMP, WPT_OP_RE_STD, CAP_SRC_REG_OR_MEM, CAP_RW_REG_OR_MEM, CAP_NONE, CAP_NONE, I_AX, I_AX),

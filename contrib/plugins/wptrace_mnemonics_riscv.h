...
static const InsnClassification riscv_insn_class[RISCV_INS_ENDING] = {
    ...
    [RISCV_INS_MULH]                = { GEN_OP_INT_MULH,  BRANCH_NONE,          MF_NONE },
    [RISCV_INS_MULHSU]              = { GEN_OP_INT_MULH,  BRANCH_NONE,          MF_NONE },
    [RISCV_INS_MULHU]               = { GEN_OP_INT_MULH,  BRANCH_NONE,          MF_NONE },
    [RISCV_INS_MULW]                = { GEN_OP_INT_MUL,   BRANCH_NONE,          MF_NONE },
    [RISCV_INS_REM]                 = { GEN_OP_INT_REM,   BRANCH_NONE,          MF_NONE },
    [RISCV_INS_REMU]                = { GEN_OP_INT_REM,   BRANCH_NONE,          MF_NONE },
    [RISCV_INS_REMUW]               = { GEN_OP_INT_REM,   BRANCH_NONE,          MF_NONE },
    [RISCV_INS_REMW]                = { GEN_OP_INT_REM,   BRANCH_NONE,          MF_NONE },
    /* RV64A atomics */

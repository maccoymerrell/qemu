...
def output_autogen():
    ...
    # The rule a pattern stands for is stated where that pattern is
    # dispatched; the statement layer's no-op stubs make this free when
    # plugins are not configured.
    output('#include "exec/insn-dataflow.h"\n\n')

...
static const ARMCPRegInfo v8_cp_reginfo[] = {
    ...
    { .name = "IC_IALLUIS", .state = ARM_CP_STATE_AA64,
      ...
      .access = PL1_W, .type = ARM_CP_NOP | ARM_CP_CACHEOP_NOT_VA,
      .fgt = FGT_ICIALLUIS,
    ...
    { .name = "IC_IVAU", .state = ARM_CP_STATE_AA64,
      ...
      .accessfn = access_tocu,
#ifdef CONFIG_USER_ONLY
      .type = ARM_CP_NO_RAW | ARM_CP_CACHEOP_VA_I,
      .writefn = ic_ivau_write
#else
      .type = ARM_CP_NOP | ARM_CP_CACHEOP_VA_I
#endif
    },
    ...
    { .name = "DC_IVAC", .state = ARM_CP_STATE_AA64,
      ...
      .fgt = FGT_DCIVAC,
      .type = ARM_CP_NOP | ARM_CP_CACHEOP_VA_D },
    { .name = "DC_ISW", .state = ARM_CP_STATE_AA64,
      .opc0 = 1, .opc1 = 0, .crn = 7, .crm = 6, .opc2 = 2,
      .fgt = FGT_DCISW,
      .access = PL1_W, .accessfn = access_tsw,
      .type = ARM_CP_NOP | ARM_CP_CACHEOP_NOT_VA },
    { .name = "DC_CVAC", .state = ARM_CP_STATE_AA64,
      .opc0 = 1, .opc1 = 3, .crn = 7, .crm = 10, .opc2 = 1,
      .access = PL0_W, .type = ARM_CP_NOP | ARM_CP_CACHEOP_VA_D,
      .fgt = FGT_DCCVAC,
...
static const ARMCPRegInfo rme_reginfo[] = {
    ...
    { .name = "DC_CIPAPA", .state = ARM_CP_STATE_AA64,
      ...
      .access = PL3_W, .type = ARM_CP_NOP | ARM_CP_CACHEOP_NOT_VA },
};
...
static const ARMCPRegInfo dcpop_reg[] = {
    { .name = "DC_CVAP", .state = ARM_CP_STATE_AA64,
      ...
      .access = PL0_W,
      .type = ARM_CP_NO_RAW | ARM_CP_SUPPRESS_TB_END | ARM_CP_CACHEOP_VA_D,
      .fgt = FGT_DCCVAP,
...
static const ARMCPRegInfo mte_reginfo[] = {
    ...
    { .name = "DC_IGVAC", .state = ARM_CP_STATE_AA64,
      ...
      .type = ARM_CP_NOP | ARM_CP_CACHEOP_VA_D, .access = PL1_W,
      .fgt = FGT_DCIVAC,
      .accessfn = aa64_cacheop_poc_access },
...
static const ARMCPRegInfo mte_el0_cacheop_reginfo[] = {
    { .name = "DC_CGVAC", .state = ARM_CP_STATE_AA64,
      ...
      .type = ARM_CP_NOP | ARM_CP_CACHEOP_VA_D, .access = PL0_W,
      .fgt = FGT_DCCVAC,
      .accessfn = aa64_cacheop_poc_access },
...
static const ARMCPRegInfo predinv_reginfo[] = {
    { .name = "CFP_RCTX", .state = ARM_CP_STATE_AA64,
      ...
      .fgt = FGT_CFPRCTX,
      .type = ARM_CP_NOP | ARM_CP_CACHEOP_NOT_VA,
      .access = PL0_W, .accessfn = access_predinv },

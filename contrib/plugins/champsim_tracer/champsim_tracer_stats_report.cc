                                 ...
                                 const Stats &stats)
{
    const struct { const char *name; uint64_t value; } counters[] = {
        ...
        { "evq oversized drains",                stats.evq_bigdrains },
        ...
        { "retention appends from untraced events",
                                                stats.retention_appends_from_untraced_events },
        { "seal successor from foreign fault",   stats.seal_successor_from_foreign_fault },
        { "fault case (b) foreign-asid matches", stats.case_b_frame_asid_mismatch },
        ...
        { "pin re-bound to a new address-space name", stats.pin_repins },
        ...
        { "windows retired on an unbindable name reassignment",
                                                stats.pin_unbindable_rollover_closes },

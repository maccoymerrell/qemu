 ...
 * @retreat_pc, dropping the sequence-prefix insns (MOVZ/MOVK immediate
 * loads) translated beyond it.  tb_stop's DISAS_TOO_MANY path targets
 * pc_curr + 4, so re-sync the private pc_curr to the last kept insn.  The

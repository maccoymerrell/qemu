                                 ...
                                 const Stats &stats)
{
    const struct { const char *name; uint64_t value; } counters[] = {
        ...
        { "census frame insns HELD at close",    stats.census_frames_held_insns },
        ...
        { "census prev insns DROPPED at close",  stats.census_prev_close_dropped_insns },
        ...
        { "census suspension insns HELD at close", stats.census_susp_held_insns },
        { "census chains HELD at close",         stats.census_chain_held_at_close },
        { "census chain insns HELD at close",    stats.census_chain_held_insns },
        ...
        { "census devio records HELD at close",  stats.census_devio_held_at_close },

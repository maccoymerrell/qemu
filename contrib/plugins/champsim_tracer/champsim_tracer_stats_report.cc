                                 ...
                                 const Stats &stats)
{
    const struct { const char *name; uint64_t value; } counters[] = {
        ...
        { "marker one-word candidates restarted", stats.marker_cand_restarts },
        { "marker one-word candidates evicted",  stats.marker_cand_evicted },
        { "marker one-word candidates at exit",  stats.marker_cand_outstanding },
        ...
        { "pin root anchors learned",            stats.pin_root_anchors },
        { "pin root schedule-ins verified",      stats.pin_root_verified },
        { "pin root anchors unresolved",         stats.pin_root_anchor_unresolved },
        { "pin root reuse detected",             stats.pin_root_reuse_detected },
        { "pin root foreign user TBs dropped",   stats.pin_root_foreign_dropped },

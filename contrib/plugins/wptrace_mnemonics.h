...
static const MnemonicEntry x86_mnemonic_table[] = {
    ...
    MNEM("imul", GEN_OP_INT_MUL, BRANCH_NONE, F_ALU, WPT_OP_RE_STD, CAP_SRC_REG_OR_MEM, CAP_RW_REG_OR_MEM, CAP_NONE, CAP_NONE),
    MNEM("mul",  GEN_OP_INT_MUL, BRANCH_NONE, F_ALU, WPT_OP_RE_STD, CAP_SRC_REG_OR_MEM, CAP_NONE, CAP_NONE, CAP_NONE),
    MNEM("idiv", GEN_OP_INT_DIV, BRANCH_NONE, F_ALU, WPT_OP_RE_STD, CAP_SRC_REG_OR_MEM, CAP_NONE, CAP_NONE, CAP_NONE),
    MNEM("div",  GEN_OP_INT_DIV, BRANCH_NONE, F_ALU, WPT_OP_RE_STD, CAP_SRC_REG_OR_MEM, CAP_NONE, CAP_NONE, CAP_NONE),
